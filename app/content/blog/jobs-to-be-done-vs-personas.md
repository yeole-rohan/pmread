---
title: "Jobs to Be Done vs Personas: Which Framework Should You Use?"
...
| Situation | Use personas | Use JTBD |
|---|---|---|
...
| Writing positioning and messaging | Both | |
...
1. **JTBD first** — Run switch interviews with recent customers and churned users. Understand the functional job, the situation that triggered the search, and the four forces for each segment.

2. **Personas second** — Use the JTBD research to build personas grounded in actual behavior, not just demographics. The persona should include the job, not just the attributes.
...
Use our [User Interview Script](/templates/user-interview-script) as a starting point for switch interviews — it includes the key sequence questions and probes for the four forces.
